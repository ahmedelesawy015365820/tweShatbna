...
<div class="page-wrapper">
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">{{$t('dashboard.Dashboard')}}</h3>
                <ul class="breadcrumb">
                            ...
                            <table class="table table-center table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>$750</td>
                                        <td class="text-end">
                                            <a href="#" class="btn btn-sm btn-success me-2"><i class="far fa-edit"></i></a>
                                            <a href="#" class="btn btn-sm btn-danger me-2"><i class="far fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <table class="table table-hover table-center mb-0 datatable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html"><img class="avatar-img rounded-circle me-2" src="admin/img/profiles/avatar-14.jpg" alt="User Image">
                                                    Janet Paden
                                                    </a>
                                                </h2>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html"><img class="avatar-img rounded-circle me-2" src="admin/img/profiles/avatar-01.jpg" alt="User Image">
                                                        George Wells
                                                    </a>
                                                </h2>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html"><img class="avatar-img rounded-circle me-2" src="admin/img/profiles/avatar-15.jpg" alt="User Image">
                                                        Timothy Smith
                                                    </a>
                                                </h2>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html"><img class="avatar-img rounded-circle me-2" src="admin/img/profiles/avatar-16.jpg" alt="User Image">
                                                        Lois Alexander
                                                    </a>
                                                </h2>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html"><img class="avatar-img rounded-circle me-2" src="admin/img/profiles/avatar-03.jpg" alt="User Image">
                                                        Sara Grayson
                                                    </a>
                                                </h2>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html"><img class="avatar-img rounded-circle me-2" src="admin/img/profiles/avatar-04.jpg" alt="User Image">
                                                        Deboarah
                                                    </a>
                                                </h2>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html"><img class="avatar-img rounded-circle me-2" src="admin/img/profiles/avatar-11.jpg" alt="User Image">
                                                        Sofia Briant
                                                    </a>
                                                </h2>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html"><img class="avatar-img rounded-circle me-2" src="admin/img/profiles/avatar-02.jpg" alt="User Image">
                                                        Bess Twishes
                                                    </a>
                                                </h2>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html"><img class="avatar-img rounded-circle me-2" src="admin/img/profiles/avatar-05.jpg" alt="User Image">
                                                        Rayan Lester
                                                    </a>
                                                </h2>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html"><img class="avatar-img rounded-circle me-2" src="admin/img/profiles/avatar-06.jpg" alt="User Image">
                                                        Sarah Alexander
                                                    </a>
                                                </h2>
                                            </td>
                                ...
                                <table class="table table-bordered table-hover datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a href="profile.html"><img class="avatar-img rounded-circle me-2" src="admin/img/profiles/avatar-10.jpg" alt="User Image">
                                                        Gary Green
                                                    </a>
                                                </h2>
                                            </td>
