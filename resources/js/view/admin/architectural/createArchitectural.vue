                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Create Architectural</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form @submit.prevent="storeArchitectural" class="needs-validation">
...
export default {
    ...
    setup(){
        ...
        return {loading,...toRefs(addArchitectural),v$};
    },
    methods: {
        storeArchitectural(){
            this.v$.$validate();
            ...
            if(!this.v$.$error){
                ...
                adminApi.post(`/v1/dashboard/architectural`,this.data)
                    .then((res) => {
