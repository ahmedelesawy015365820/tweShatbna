...
<!--                                    </div>-->
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                    <tr v-for="(item,index) in companies" v-if="companies" :key="item.id">
                                        <td>{{index + 1}}</td>
            ...
            <!-- /Table -->
            <!-- start Pagination -->
            <Pagination :data="companyPaginate" @pagination-change-page="getCompany">
                <template #prev-nav>
                    <span>&lt; Previous</span>
                </template>
                <template #next-nav>
...
export default {
    ...
    setup(){
        ...
        let getCompany = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/trustCompany?page=${page}&search=${search.value}`)
                .then((res) => {
                    let l = res.data.data;
                    companyPaginate.value = l.company;
                    companies.value = l.company.data;
                })
                .catch((err) => {
        ...
        return {companyPaginate,loading,getCompany,search,companies};
