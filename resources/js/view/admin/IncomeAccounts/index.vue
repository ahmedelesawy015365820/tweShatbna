                            ...
                            <div class="card-header pt-0">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-5 row justify-content-end">
                                        <router-link
                                            :to="{name: 'createIncomeAccounts', params: {lang: locale || 'ar'}}"
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tr v-for="(item,index) in incomes" v-if="incomes" :key="item.id">
                                        ...
                                        <td>
                                            ...
                                            <router-link
                                                :to="{name: 'editIncomeAccounts', params: {lang: locale || 'ar',id:item.id}}"
...
export default {
    ...
    setup() {
        ...
        let getIncome = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/mainAccount/4?page=${page}&search=${search.value}`)
                .then((res) => {
                    let l = res.data.data;
