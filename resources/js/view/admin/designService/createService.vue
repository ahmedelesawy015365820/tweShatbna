            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexService', params: {lang: locale || 'ar'}}">Design Services</router-link></li>
                            <li class="breadcrumb-item active">Create Design Service</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form @submit.prevent="storeService" class="needs-validation">
...
export default {
    ...
    setup(){
        ...
        return {loading,...toRefs(addService),v$};
    },
    methods: {
        storeService(){
            this.v$.$validate();
            ...
            if(!this.v$.$error){
                ...
                adminApi.post(`/v1/dashboard/designService`,this.data)
                    .then((res) => {
