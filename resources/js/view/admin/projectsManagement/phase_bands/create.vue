<template>
    <div :class="['page-wrapper',this.$i18n.locale == 'ar'? 'page-wrapper-ar':'']">
        ...
        <div class="content container-fluid">
            ...
            <Breadcrumb :title="$t('global.Create Band')" routeName='indexPhaseBands' />
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <form @submit.prevent="createPhaseBands(formData)" class="needs-validation">
...
export default {
    ...
    setup(){
        // get create Package
        const {errors,loading,formData,createPhaseBands} = phaseBandsComposable()
        formData.value={
            ar:{name:''},
            en:{name:''},
            percentage:'',
        ...
        return {errors,loading,formData,createPhaseBands};
    },
