            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexDepartment', params: {lang: locale || 'ar'}}">{{$t('global.Department')}}</router-link></li>
                            <li class="breadcrumb-item active">{{$t('department.EditDepartment')}}</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0 mb-4">
                                <router-link
                                    :to="{name: 'indexDepartment', params: {lang: locale || 'ar'}}"
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form @submit.prevent="editDepartment" class="needs-validation">
...
export default {
    ...
    setup(props){
        ...
        let getMainDepartmentViews = () => {
            ...
            adminApi.get(`/v1/dashboard/department/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
                    addDepartment.data.en.name = l.department.translations[1].name;
                    addDepartment.data.ar.name = l.department.translations[0].name;
                    console.log(l)
                })
                .catch((err) => {
    ...
    methods: {
        editDepartment(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/department/${this.id}`,this.data)
                    .then((res) => {
