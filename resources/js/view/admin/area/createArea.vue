                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{$t('global.Create Area')}}</li>
                        </ul>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="form-row row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="valid-feedback">{{$t('global.Looks good!')}}</div>
                                                    <div class="invalid-feedback">
                                                        <span v-if="v$.country_id.required.$invalid">{{$t('global.Country  is required')}}.</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
...
export default {
    ...
    setup(){
        ...
        return {loading,...toRefs(addArea),v$,countries,states,getStates};
    },
    methods: {
        storeArea(){
            this.v$.$validate();
