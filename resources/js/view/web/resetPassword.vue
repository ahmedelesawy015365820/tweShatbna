...
import { maxLength, minLength, required,email,sameAs,alphaNum} from "@vuelidate/validators";
...
export default {
    ...
    beforeMount() {
        ...
        if (!this.data.token)
        {
           return this.$router.push({name:'home',params:{lang:localStorage.getItem('langWeb') || 'ar'}});
        }
