<template>
    <div :class="['page-wrapper',this.$i18n.locale == 'ar'? 'page-wrapper-ar':'']">
        ...
        <div class="content container-fluid">
            ...
            <Breadcrumb :title="$t('global.Create New Cost')" routeName='indexWeightCost' />
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <form @submit.prevent="createWeightCost(formData)" class="needs-validation">
...
export default {
    ...
    setup(){
        // get create Package
        const {errors,loading,formData,createWeightCost} = weightCostComosable()
        formData.value={
            to:'',
            from:'',
            cost:'',
        ...
        return {errors,loading,formData,createWeightCost};
    },
