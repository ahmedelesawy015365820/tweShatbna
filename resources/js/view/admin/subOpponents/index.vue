                        ...
                        <ul class="breadcrumb">
                            ...
                            <li  :class="['breadcrumb-item']" v-for=" (it,key) in mainData">
                                <router-link @click="clickFunc"
                                    v-if="id != it.id" :to="{name: 'indexSubOpponents', params: {lang: locale || 'ar',id:it.id,mainId:2}}">
                                    {{ it.name }}
                                </router-link>
                            </li>
                            ...
                            <div class="card-header pt-0">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-5 row justify-content-end">
                                        <router-link
                                            :to="{name: 'createSubOpponents', params: {lang: locale || 'ar',id:id,mainId:mainId}}"
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tr v-for="(item,index) in incomes" v-if="incomes" :key="item.id">
                                        ...
                                        <td>
                                            ...
                                            <router-link
                                                :to="{name: 'editSubOpponents', params: {lang: locale || 'ar',id:item.id,mainId:2}}"
