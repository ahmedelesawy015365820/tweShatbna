            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexExpense', params: {lang: locale || 'ar'}}">{{$t('global.Expenses')}}</router-link></li>
                                    ...
                                    <form @submit.prevent="editExpense" class="needs-validation">
                                        ...
                                        <div class="form-row row">
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label">{{$t('expense.ChooseExpense')}}</label>
                                                <div class="col-lg-9">
        ...
        let getMainExpenseViews = () => {
            ...
            adminApi.get(`/v1/dashboard/expense/${id.value}/edit`)
                .then((res) => {
                    ...
                    addExpense.data.en.name = l.expense.translations[1].name;
                    addExpense.data.ar.name = l.expense.translations[0].name;
                    addExpense.data.active = l.expense.active;
