            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexAdvisorPackage', params: {lang: locale || 'ar'}}">{{$t('global.AdvisorPackage')}}</router-link></li>
                            <li class="breadcrumb-item active">{{$t('advisorPackage.EditAdvisorPackage')}}</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0 mb-4">
                                <router-link
                                    :to="{name: 'indexAdvisorPackage', params: {lang: locale || 'ar'}}"
                                    ...
                                    <form @submit.prevent="editPackage" class="needs-validation">
                                        <div class="form-row row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="valid-feedback">{{$t('global.LooksGood')}}</div>
                                                <div class="invalid-feedback">
                                                    <span v-if="v$.price.required.$invalid">{{$t('global.PriceIsRequired')}} <br /></span>
                                                </div>
                                            </div>
...
export default {
    ...
    setup(props){
        ...
        let getMainPackageViews = () => {
            ...
            adminApi.get(`/v1/dashboard/advisorPackage/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
                    ...
                    addPackage.data.price = l.package.price;
                })
                .catch((err) => {
    ...
    methods: {
        editPackage(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/advisorPackage/${this.id}`,this.data)
                    .then((res) => {
