<template>
    <div :class="['page-wrapper',this.$i18n.locale == 'ar'? 'page-wrapper-ar':'']">
        ...
        <div class="content container-fluid">
            ...
            <Breadcrumb :title="$t('global.Update Band')" routeName='indexPhaseBands' />
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0 mb-4">
                                <router-link
                                    :to="{name: 'indexPhaseBands', params: {lang: locale || 'ar'}}"
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <form @submit.prevent="updatePhaseBands(formData,id)" class="needs-validation">
                                        <div class="form-row row">
                                            <div class="col-md-4 mb-3">
                                                <label for="validationCustom01">{{$t('global.Band Name in Arabic')}}</label>
                                                <input type="text"
                                                       class="form-control"
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <label for="validationCustom02">{{$t('global.Band Name in English')}}</label>
                                                <input type="text"
                                                       class="form-control"
...
export default {
    ...
    setup(props){
        // get create Package
        const {errors,loading,formData,updatePhaseBands,getBand} = phaseBandsComposable()
        formData.value={
            ar:{name:''},
            en:{name:''},
            percentage:'',
        ...
        return {errors,loading,formData,updatePhaseBands};
    },
