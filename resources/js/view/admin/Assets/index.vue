                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $t('global.Assets') }}</li>
                        </ul>
                    </div>
                            ...
                            <div class="card-header pt-0">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-5 row justify-content-end">
                                        <router-link
                                            :to="{name: 'createAssets', params: {lang: locale || 'ar'}}"
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tr v-for="(item,index) in incomes" v-if="incomes" :key="item.id">
                                        ...
                                        <td>{{ $t('global.Assets') }}</td>
                                        <td>{{ dateFormat(item.created_at) }}</td>

                                        <td>

                                            <router-link
                                                :to="{name: 'editAssets', params: {lang: locale || 'ar',id:item.id}}"
...
export default {
    ...
    setup() {
        ...
        let getIncome = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/mainAccount/1?page=${page}&search=${search.value}`)
                .then((res) => {
                    let l = res.data.data;
        ...
        return {main,incomes, loading, getIncome,dateFormat, search, deleteIncome, incomesPaginate};
