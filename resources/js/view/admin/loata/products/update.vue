<template>
    <div :class="['page-wrapper',this.$i18n.locale == 'ar'? 'page-wrapper-ar':'']">
        ...
        <div class="content container-fluid">
            ...
            <Breadcrumb :title="$t('global.Update Product')" routeName='Products' />
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <form @submit.prevent="updateProduct($event,id)" class="needs-validation">
                                        <input type="hidden" value="put" name="_method">
                                        <div class="form-row row">
                                            <div class="col-md-4 mb-3">
                                                <label for="validationCustom02">{{$t('global.Product Name in Arabic')}}</label>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <select name="category_id" class="form-control" id="validationCustom00"  v-model.trim="formData.category_id">
                                                    <option value=""></option>
                                            ...
                                            <div class="col-md-3 mb-3">
                                                ...
                                                <input type="datetime-local"
                                                       ...
                                                       id="validationCustom05"
                                                       name="expiry_date"
                                                       v-model.trim="formData.expiry_date"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <textarea type="text" dir="rtl"
                                                       ...
                                                       v-model.trim="formData.ar.description"
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <textarea type="text" dir="ltr"
                                                       class="form-control"
                                                       name="en[description]"
                                                       v-model.trim="formData.en.description"
...
export default {
    ...
    setup(props){
        // get create Package
        const {errors,loading,formData,updateProduct,getProduct,getCategories,categories} = productsComposable()
        formData.value={
            ar:{name:'',description:'',divo:''},
            en:{name:'',description:'',divo:''},
            price:'',
            sale:'',
            stock:'',
            weight:'',
        ...
        return {errors,loading,formData,updateProduct,categories};
    },
