<template>
    <div :class="['page-wrapper',this.$i18n.locale == 'ar'? 'page-wrapper-ar':'']">
        <div class="content container-fluid">
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-5 row justify-content-end">
                                        <router-link
                                            :to="{name: 'createDepartment', params: {lang: locale || 'ar'}}"
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                    <tr v-for="(item,index) in departments" v-if="departments" :key="item.id">
                                        <td>{{ index + 1 }}</td>
                                        <td>{{ item.name }}</td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <router-link
                                                :to="{name: 'editDepartment', params: {lang: locale || 'ar',id:item.id}}"
            ...
            <!-- /Table -->
            <!-- start Pagination -->
            <Pagination :data="departmentsPaginate" @pagination-change-page="getDepartment">
                <template #prev-nav>
...
export default {
    ...
    setup() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    adminApi.delete(`/v1/dashboard/department/${id}`)
                        .then((res) => {
                            departments.value.splice(index, index + 1);
        ...
        return {departments, loading, getDepartment, search, deleteDepartment, activationDepartment, departmentsPaginate};
