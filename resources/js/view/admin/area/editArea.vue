            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexArea', params: {lang: locale || 'ar'}}">Area</router-link></li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0 mb-4">
                                <router-link
                                    :to="{name: 'indexArea', params: {lang: locale || 'ar'}}"
                                    ...
                                    <form @submit.prevent="storeArea" class="needs-validation">
                                        <div class="form-row row">
                                            <div class="col-md-4 mb-3">
                                                <label for="validationCustom01">{{$t('global.Area En')}}</label>
                                                ...
                                                >
                                                <div class="valid-feedback">{{$t('global.Looks good!')}}</div>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <label for="validationCustom02">{{$t('global.Area Ar')}}</label>
                                                <input type="text"
                                                       class="form-control"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="WebsitePages">{{$t('global.Country')}}</label>
                                                    <select @change="getStates(v$.country_id.$model)"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="WebsitePages">{{$t('global.State')}}</label>
                                                    <select
                                                        class="form-control coustom-select"
                                                        id="WebsitePages"
                                                        v-model="v$.state_id.$model"
                                                        :class="{'is-invalid':v$.state_id.$error,'is-valid':!v$.state_id.$invalid}"
                                                    >
                                                        <option  value=""></option>
                                                    ...
                                                    <div class="valid-feedback">{{$t('global.Looks good!')}}</div>
                                                    <div class="invalid-feedback">
                                                        <span v-if="v$.state_id.required.$invalid">{{$t('global.State  is required')}}.</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card col-md-4" style="height: 138px;">
                                                ...
                                                <div class="card-footer">
                                                    <label class="form-group toggle-switch mb-0" for="notification_switch1">
                                                        <input type="checkbox" v-model="data.status" :checked="data.status"  class="toggle-switch-input" id="notification_switch1">
...
export default {
    ...
    setup(props){
        ...
        let getDATA = () => {
            ...
            adminApi.get(`/v1/dashboard/area/${id.value}/edit`)
                .then((res) => {
                    ...
                    states.value = l.states;

                    addArea.data.en.name = l.area.translations[0].name;
                    addArea.data.ar.name = l.area.translations[1].name;
                    addArea.data.country_id = l.area.state.country_id;
                    addArea.data.state_id = l.area.state_id;
                    addArea.data.status = l.area.status;
        ...
        const getStates = async (id) => {
            ...
            adminApi.get(`/v1/dashboard/country_states/${id}`)
                .then((res) => {
                    console.log(res)
                    let l = res.data.data;
                    states.value = l.states;
                    addArea.data.state_id = ''
                })
                .catch((err) => {
                    console.log(err.response.data);
                })
        ...
        return {loading,...toRefs(addArea),v$,countries,id,states,getStates};
    },
    methods: {
        storeArea(){
            this.v$.$validate();
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/area/${this.id}`,this.data)
                    .then((res) => {
                        ...
                        this.$router.push({name:'indexArea'})
