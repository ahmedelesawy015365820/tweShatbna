        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                ...
                <div class="trust> col-10" >
                    <div class="row">
                        <router-link class="btn main-page" :to="{name:'dashboardClient',params:{lang:this.$i18n.locale}}">
                            العوده للرئيسية
                        </router-link>
                        <ul class="col-12">
                            <div class="row justify-content-center">
                                ...
                                <li :class="['col-lg-3' ,'col-sm-6' ,'wazard2',(step > 2 && this.$i18n.locale == 'ar')?'active' : '',(step > 2 && this.$i18n.locale != 'ar') ?'active-en' : '']" v-if="valueComplement">
                                    <div class="text-center">
                            ...
                            <div class="form">
                                <form @submit.prevent="step3Resault" enctype="multipart/form-data">
                                    <div class="row justify-content-center">
                                        ...
                                        <div v-if="valueComplement" :class="['col-lg-10',step == 3?'active' : '']">
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-4 mb-3">
                                                        ...
                                                        <select
                                                            ...
                                                            v-model="v$.person.country.$model"
                                                            @change="conutryState"
                                                        >
                                                            <option selected disabled>اختار...</option>
                                                            <option :value="country.id" v-for="country in countries">{{country.name}}</option>
                                                        </select>
                                                        <div v-if="v$.person.country.$error">
                                                            <span class="text-danger" v-if="v$.person.country.required.$invalid">country is required.<br /> </span>
                                                        </div>
                                                    </div>

                                                    <div class="col-md-4 mb-3">
                                                        <label for="validationCustom02">المحافظة</label>
                                                        <select
                                                            class="custom-select form-control"
                                                            id="validationCustom02"
                                                            v-model="v$.person.state.$model"
                                                        >
                                                            <option selected disabled>اختار...</option>
                                                            <option :value="state.id" v-for="state in states">{{state.name}}</option>
                                                        </select>
                                                        <div v-if="v$.person.state.$error">
                                                            <span class="text-danger" v-if="v$.person.state.required.$invalid">state is required.<br /> </span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 mb-3" style="position: relative">
                                                        ...
                                                        <input
                                                            ...
                                                            v-model.trim="v$.person.phone.$model"
                                                        >
                                                        <span class="flag"  v-if="person.country" v-for="count in foucsCountry">
                                                            <img v-if="this.$i18n.locale == 'en'" :src="'/web/img/country/'+ count.media.file_name">
                                                            <span id="phoneClient" class="codeCountry">{{count.code}}</span>
                                                            <img v-if="this.$i18n.locale == 'ar'" :src="'/web/img/country/'+ count.media.file_name">
                                                        </span>
                                                        <div v-if="v$.person.phone.$error || !validatePhone">
                                                            <span class="text-danger" v-if="v$.person.phone.required.$invalid">phone is required.<br /> </span>
                                                            <span class="text-danger" v-if="!validatePhone">phone is not valid.<br /> </span>
                                                        </div>
                                                    </div>
...
import {maxLength, required, alphaNum} from "@vuelidate/validators";
...
export default {
    ...
    setup(){
        ...
        let validatePhone = ref(true);

        let conutryState =  () => {

            foucsCountry.value = countries._value.filter(country => country.id == data.person.country);
            store.dispatch('auth/stateRegister',data.person.country);
        };
        ...
        const valueComplement = ref(true);
        ...
        onMounted(() =>{
            ...
            if(JSON.parse(localStorage.getItem('user')).phone){
                valueComplement.value = false;
            }
        });

        return {data,validatePhone,foucsCountry,countries,states,conutryState,valueComplement,loading,...toRefs(data),numberOfImage1,numberOfImage2,numberOfImage3,preview1,preview2,preview3,step,step1Func,step1FuncBack1,step1FuncBack2,v$}
    },
    methods: {
        step2Func (){
                        ...
                        if (result.isConfirmed) {
                            ...
                            webApi.post(`/v1/web/clientData`,formData)
                                .then((res) => {
                                    ...
                                    setTimeout(() => {
                                        return this.$router.push({name:'dashboardClient',params:{lang:this.$i18n.locale}});
                                    },1000);
                                })
                                .catch((err) => {
