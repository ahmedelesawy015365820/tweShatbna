                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <router-link :to="{name: 'indexAdvisorDetail', params: {lang: locale || 'ar',id:idAdvisor}}">
                                    {{ $t('global.AdvisorShatbnaPackageDetails') }}
                                </router-link>
                            </li>
                            <li class="breadcrumb-item active">{{ $t('advisorDetail.EditAdvisorShatbnaPackageDetails') }}</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0 mb-4">
                                <router-link
                                    :to="{name: 'indexAdvisorDetail', params: {lang: locale || 'ar',id:idAdvisor}}"
...
export default {
    ...
    props:["idAdvisor","idDetail"],
    setup(props){
        const emitter = inject('emitter');

        const {idAdvisor,idDetail} = toRefs(props);
        const {t} = useI18n({});
        let job = ref({});
        ...
        let getMainPackageViews = () => {
            ...
            adminApi.get(`/v1/dashboard/advisorDetail/${idDetail.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
    ...
    methods: {
        editPackage(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/advisorDetail/${this.idDetail}`,this.data)
                    .then((res) => {
