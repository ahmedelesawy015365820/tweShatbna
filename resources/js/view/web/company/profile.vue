                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div v-if="v$.info.nameService.$error">
                                                    <span class="text-danger" v-if="v$.info.nameService.required.$invalid">Service is required.<br /> </span>
                                                </div>
                                            </div>
...
export default {
    ...
    setup(){
        ...
        const getDetail = () =>{
            webApi.get(`/v1/web/getCompanyDetails`)
                .then((res) => {
                    let l =res.data.data;
                    data.info.vision = l.detail.vision;
                    data.info.message = l.detail.message;
                    data.info.strategy = l.detail.strategy;
                    l.service.forEach((e) => {
                        data.info.nameService.push(e.id);
                    });
                })
                .catch((err) => {
                    Swal.fire({
        ...
        return {services,banks,v$,...toRefs(data),hide,loading,getBanks,deleteBank};
    },
    methods:{
        bankStore() {
            ...
            if(!this.v$.info.$error){
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        this.loading = true;
                        webApi.post(`/v1/web/storeCompanyDetail`,this.info)
                            .then((res) => {
