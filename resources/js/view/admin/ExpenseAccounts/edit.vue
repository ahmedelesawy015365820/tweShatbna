            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexExpenseAccounts', params: {lang: locale || 'ar'}}">{{$t('global.Expenses')}}</router-link></li>
                            <li class="breadcrumb-item active">{{$t('Assets.Edit')}}</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0 mb-4">
                                <router-link
                                    :to="{name: 'indexExpenseAccounts', params: {lang: locale || 'ar'}}"
...
export default {
    ...
    setup(props){
        ...
        let getMainIncomeViews = () => {
            ...
            adminApi.get(`/v1/dashboard/mainAccount/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
    ...
    methods: {
        editIncome(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/mainAccount/${this.id}`,this.data)
                    .then((res) => {
