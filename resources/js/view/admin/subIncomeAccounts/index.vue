        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <div class="row">
                            <h3 class="page-title col-md-3">{{ $t('global.Incomes') }}</h3>
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li  :class="['breadcrumb-item']" v-for=" (it,key) in mainData">
                                <router-link @click="clickFunc"
                                    v-if="id != it.id" :to="{name: 'indexSubIncomeAccounts', params: {lang: locale || 'ar',id:it.id,mainId:4}}">
                                    {{ it.name }}
                                </router-link>
                            </li>
                            ...
                            <div class="card-header pt-0">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-5 row justify-content-end">
                                        <router-link
                                            :to="{name: 'createSubIncomeAccounts', params: {lang: locale || 'ar',id:id,mainId:mainId}}"
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tr v-for="(item,index) in incomes" v-if="incomes" :key="item.id">
                                        ...
                                        <td>
                                            ...
                                            <router-link
                                                :to="{name: 'editSubIncomeAccounts', params: {lang: locale || 'ar',id:item.id,mainId:4}}"
                                                class="btn btn-sm btn-success me-2">
                                                <i class="far fa-edit"></i>
                                            </router-link>

                                            <router-link @click="clickFunc"
                                                :to="{name: 'indexSubIncomeAccounts', params: {lang: locale || 'ar',id:item.id,mainId:4}}"
...
export default {
    ...
    setup(props) {
        ...
        let getIncome = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/subAccount/${mainId.value}/${id.value}?page=${page}&search=${search.value}`)
                .then((res) => {
                    ...
                    console .log(l.subAccounts.data[0].parent);
        ...
        return {main,id,mainId,mainData,incomes, loading, getIncome,dateFormat, search, deleteIncome,clickFunc, incomesPaginate};
