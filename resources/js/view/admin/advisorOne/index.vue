        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">{{ $t('global.FirstSectionData') }}</h3>
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $t('global.FirstSectionData') }}</li>
                        </ul>
                    </div>
                            ...
                            <div class="card-header pt-0">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-5 row justify-content-end" v-if="advisors.length < 3">
                                        <router-link
                                            :to="{name: 'createAdvisorOne', params: {lang: locale || 'ar'}}"
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tr v-for="(item,index) in advisors" v-if="advisors" :key="item.id">
                                        ...
                                        <td>
                                            <router-link
                                                :to="{name: 'editAdvisorOne', params: {lang: locale || 'ar',id:item.id}}"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">{{$t('advisorOne.ShowAdvisorOne')}}</h4>
...
export default {
    ...
    setup() {
        ...
        let getAdvisor = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/advisorOne?page=${page}&search=${search.value}`)
                .then((res) => {
                    let l = res.data.data;
        ...
        function deleteDetails(id, advisorsName, index) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    adminApi.delete(`/v1/dashboard/advisorOne/${id}`)
                        .then((res) => {
