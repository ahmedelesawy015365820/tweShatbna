<template>
  ...
  >
    <div class="content container-fluid">
      ...
      <Breadcrumb
        :title="$t('global.Create New Cost')"
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-sm">
                  <form
                    @submit.prevent="createAreaCost(formData)"
...
export default {
  ...
  setup() {
    ...
    return { errors, loading, formData, createAreaCost ,getAreas,getStates,areas,countries,states};
  },
};
</script>
