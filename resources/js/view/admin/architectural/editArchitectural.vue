            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexArchitectural', params: {lang: locale || 'ar'}}">Architectural</router-link></li>
                            <li class="breadcrumb-item active">Edit Architectural</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0 mb-4">
                                <router-link
                                    :to="{name: 'indexArchitectural', params: {lang: locale || 'ar'}}"
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    ...
                                    <form @submit.prevent="editArchitectural" class="needs-validation">
                                        <div class="form-row row">
                                            <div class="col-md-4 mb-3">
                                                <label for="validationCustom01">Architectural En</label>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <label for="validationCustom02">Architectural Ar</label>
                                                <input type="text"
                                                       class="form-control"
...
export default {
    ...
    setup(props){
        ...
        let getDATA = () => {
            ...
            adminApi.get(`/v1/dashboard/architectural/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
                    addArchitectural.data.en.name = l.architectural.translations[1].name;
                    addArchitectural.data.ar.name = l.architectural.translations[0].name;
                    addArchitectural.data.status = l.architectural.status;
                })
                .catch((err) => {
        ...
        const v$ = useVuelidate(rules,addArchitectural.data);


        return {loading,...toRefs(addArchitectural),id,v$};
    },
    methods: {
        editArchitectural(){
            this.v$.$validate();
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/architectural/${this.id}`,this.data)
                    .then((res) => {
