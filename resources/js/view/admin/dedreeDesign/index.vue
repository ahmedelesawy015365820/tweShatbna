<template>
    <div :class="['page-wrapper',this.$i18n.locale == 'ar'? 'page-wrapper-ar':'']">
        <div class="content container-fluid">
                            ...
                            <div class="card-header pt-0">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-5 row justify-content-end">
                                        <router-link
                                            :to="{name: 'createDegree', params: {lang: locale || 'ar'}}"
                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody v-if="degrees.length">
                                        <tr v-for="(item,index) in degrees"  :key="item.id">
                                            ...
                                            <td>
                                                <router-link :to="{name: 'editDegree', params: {lang: locale || 'ar',id:item.id}}" class="btn btn-sm btn-success me-2">
            ...
            <!-- /Table -->
            <!-- start Pagination -->
            <Pagination :data="degreesPaginate" @pagination-change-page="getServices">
                <template #prev-nav>
                    <span>&lt; Previous</span>
                </template>
                <template #next-nav>
...
export default {
    ...
    setup(){
        ...
        let getServices = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/degreeDesign?page=${page}&search=${search.value}`)
                .then((res) => {
                    let l = res.data.data;
                    degreesPaginate.value = l.design;
                    degrees.value = l.design.data;
                })
                .catch((err) => {
         ...
         function deleteCountry(id,index){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    adminApi.delete(`/v1/dashboard/degreeDesign/${id}`)
                        .then((res) => {
                            degrees.value.splice(index,index + 1);
        ...
        return {degrees,loading,getServices,search,deleteCountry,degreesPaginate};
