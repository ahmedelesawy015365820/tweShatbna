                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ $t('global.Sizing service data') }}</li>
                        </ul>
                    </div>
                            ...
                            <div class="card-header pt-0">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-5 row justify-content-end" v-if="advisors.length < 3">
                                        <router-link
                                            :to="{name: 'createSizingOne', params: {lang: locale || 'ar'}}"
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tr v-for="(item,index) in advisors" v-if="advisors" :key="item.id">
                                        ...
                                        <td>
                                            <router-link
                                                :to="{name: 'editSizingOne', params: {lang: locale || 'ar',id:item.id}}"
...
export default {
    ...
    setup() {
        ...
        let getAdvisor = (page = 1) => {
            ...
            adminApi.get(`/v1/dashboard/sizingOne?page=${page}&search=${search.value}`)
                .then((res) => {
                    let l = res.data.data;
        ...
        function deleteDetails(id, advisorsName, index) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    adminApi.delete(`/v1/dashboard/sizingOne/${id}`)
                        .then((res) => {
