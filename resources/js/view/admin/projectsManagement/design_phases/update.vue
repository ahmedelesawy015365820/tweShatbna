<template>
    <div :class="['page-wrapper',this.$i18n.locale == 'ar'? 'page-wrapper-ar':'']">
        ...
        <div class="content container-fluid">
            ...
            <Breadcrumb :title="$t('global.Update Design Phase')" routeName='indexDesignPhases' />
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0 mb-4">
                                <router-link
                                    :to="{name: 'indexDesignPhases', params: {lang: locale || 'ar'}}"
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <form @submit.prevent="updateDesignPhase($event,id)" class="needs-validation">
...
export default {
    ...
    setup(props){
        // get create Package
        const {errors,loading,formData,updateDesignPhase,getPhase} = designPhasesComposable()
        formData.value={
            ar:{name:''},
            en:{name:''},
            id:props.id,
        ...
        return {errors,loading,formData,updateDesignPhase};
    },
