                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Edit Academic Degree</li>
                        </ul>
                    </div>
                </div>
            </div>
...
export default {
    ...
    setup(props){
        ...
        let getDATA = () => {
            ...
            adminApi.get(`/v1/dashboard/degreeDesign/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
                    addDesign.data.en.name = l.design.translations[1].name;
                    addDesign.data.ar.name = l.design.translations[0].name;
                    addDesign.data.status = l.design.status;
                })
                .catch((err) => {
        ...
        return {loading,...toRefs(addDesign),id,v$};
    },
    methods: {
        editService(){
            this.v$.$validate();
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/degreeDesign/${this.id}`,this.data)
                    .then((res) => {
