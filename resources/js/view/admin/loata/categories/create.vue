<template>
    <div :class="['page-wrapper',this.$i18n.locale == 'ar'? 'page-wrapper-ar':'']">
        ...
        <div class="content container-fluid">
            ...
            <Breadcrumb :title="$t('global.Create Category')" routeName='Categories' />
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <form @submit.prevent="createCategory(formData)" class="needs-validation">
                                        <div class="form-row row">
                                            <div class="col-md-6 mb-3">
                                                <label for="validationCustom02">{{$t('global.Category Name in Arabic')}}</label>
                                                <input type="text"
                                                       class="form-control"
...
export default {
    ...
    setup(){
        // get create Package
        const {errors,loading,createCategory,formData} = categoriesComposable()
        ...
        return {errors,loading,createCategory,formData};
    },
