        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Design Service</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexService', params: {lang: locale || 'ar'}}">Design Service</router-link></li>
                            <li class="breadcrumb-item active">Edit Design Service</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0 mb-4">
                                <router-link
                                    :to="{name: 'indexService', params: {lang: locale || 'ar'}}"
...
export default {
    ...
    setup(props){
        ...
        let getDATA = () => {
            ...
            adminApi.get(`/v1/dashboard/designService/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
                    addService.data.en.name = l.design.translations[1].name;
                    addService.data.ar.name = l.design.translations[0].name;
                    addService.data.status = l.design.status;
                })
                .catch((err) => {
    ...
    methods: {
        editService(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/designService/${this.id}`,this.data)
                    .then((res) => {
