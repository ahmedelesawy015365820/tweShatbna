...
function designPhasesComposable() {
  ...
  var designPhases = (0,vue__WEBPACK_IMPORTED_MODULE_2__.ref)({}); //data for index page
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              loading.value = true;
              _api_adminAxios__WEBPACK_IMPORTED_MODULE_1__["default"].get("/v1/dashboard/designPhases?page=".concat(page, "&search=").concat(search.value)).then(function (res) {
            ...
            case 0:
              Swal.fire({
                ...
                if (result.isConfirmed) {
                  _api_adminAxios__WEBPACK_IMPORTED_MODULE_1__["default"]["delete"]("/v1/dashboard/designPhases/".concat(id)).then(function (res) {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 5;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_1__["default"].post('/v1/dashboard/designPhases', form).then(function (result) {
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              form.append('id', id);
              _context4.next = 6;
              return _api_adminAxios__WEBPACK_IMPORTED_MODULE_1__["default"].post('/v1/dashboard/designPhases/' + id, form).then(function (result) {
                console.log(result);
                (0,_kyvg_vue3_notification__WEBPACK_IMPORTED_MODULE_3__.notify)({
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _api_adminAxios__WEBPACK_IMPORTED_MODULE_1__["default"].get("/v1/dashboard/designPhases/".concat(id)).then(function (res) {
                formData.value = {
                  ar: {
