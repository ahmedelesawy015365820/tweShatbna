<template>
    <div :class="['page-wrapper',this.$i18n.locale == 'ar'? 'page-wrapper-ar':'']">
        <div class="content container-fluid">
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        <tr v-for="(item,index) in dailies" v-if="dailies" :key="item.id">
                                            <td>{{ item.id }}</td>
                                            <td>{{ item.desc }}</td>
                                            <td>{{ item.amount }}</td>
                                            <td>
                                                                        ...
                                                                        <div role="tabpanel" :id="'tab-4-'+item.id" class="tab-pane fade active show">
                                                                            ...
                                                                            <div class="row justify-content-between">
                                                                                ...
                                                                                <div class="col-5 row justify-content-end">
                                                                                    <router-link @click="close(item.id)"
            ...
            <!-- start Pagination -->
            <Pagination :data="dailyPaginate" @pagination-change-page="getIncome">
                <template #prev-nav>
...
export default {
    ...
    setup() {
        ...
        let getIncome = () => {
            ...
            adminApi.get(`/v1/dashboard/dailyRestriction?&id=${treasury_id.value}&from_date=${fromDate.value}&to_date=${toDate.value}&search=${search.value}`)
                .then((res) => {
        ...
        return {dailyPaginate,search,totalCreditor,totalDebit,treasury_id,fromDate,toDate,dailies, loading,dateFormat,printData, getIncome,close};
