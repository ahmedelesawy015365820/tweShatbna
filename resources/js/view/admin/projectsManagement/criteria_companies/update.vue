<template>
    <div :class="['page-wrapper',this.$i18n.locale == 'ar'? 'page-wrapper-ar':'']">
        ...
        <div class="content container-fluid">
            ...
            <Breadcrumb :title="$t('global.Update Company Criteria')" routeName='indexCompanyCriteria' />
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm">
                                    <form @submit.prevent="updateCompanyCriteria(formData,id)" class="needs-validation">
...
export default {
    ...
    setup(props){
        // get create Package
        const {errors,loading,formData,updateCompanyCriteria,geCriteria} = companyCriteriaComposable()
        formData.value={
            ar:{name:''},
            en:{name:''},
            percentage:'',
        ...
        return {errors,loading,formData,updateCompanyCriteria};
    },
