                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Update Privacy</li>
                        </ul>
                    </div>
                </div>
            </div>
...
export default {
    ...
    setup(props){
        ...
        let getPrivacy = () => {
            ...
            adminApi.get(`/v1/dashboard/privacy/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
                    addPrivacy.data.en.title = l.privacy.translations[1].title;
                    addPrivacy.data.ar.title = l.privacy.translations[0].title;
                    addPrivacy.data.en.description = l.privacy.translations[1].description;
                    addPrivacy.data.ar.description = l.privacy.translations[0].description;
                })
                .catch((err) => {
        ...
        return {loading,...toRefs(addPrivacy),v$,id};
    },
    methods: {
        storeCountry(){
            this.v$.$validate();
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/privacy/${this.id}`,this.data)
                    .then((res) => {
