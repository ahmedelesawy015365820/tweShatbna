            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><router-link :to="{name: 'indexAdvisorOne', params: {lang: locale || 'ar'}}">{{$t('global.FirstSectionData')}}</router-link></li>
                            <li class="breadcrumb-item active">{{$t('advisorOne.EditAdvisorOne')}}</li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="card-header pt-0 mb-4">
                                <router-link
                                    :to="{name: 'indexAdvisorOne', params: {lang: locale || 'ar'}}"
...
export default {
    ...
    setup(props){
        ...
        let getMainPackageViews = () => {
            ...
            adminApi.get(`/v1/dashboard/advisorOne/${id.value}/edit`)
                .then((res) => {
                    let l = res.data.data;
    ...
    methods: {
        editPackage(){
            ...
            if(!this.v$.$error){
                ...
                adminApi.put(`/v1/dashboard/advisorOne/${this.id}`,this.data)
                    .then((res) => {
